export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'ehippofund',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Ehippofund',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'ehippofund.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://ehippofund.com',
