...
export const taskPageVoices = {
  ...
  sbm: {
    eyebrow: 'Reads',
    headline: 'Useful links arranged like curated collections.',
    description: 'Read pages should feel like shelves of tools, references, and sources worth opening.',
    filterLabel: 'Filter read category',
    secondaryNote: 'Curated links need grouping and calm metadata.',
  ...
  listing: {
    ...
    description: 'Place pages should behave like a directory with trust cues, metadata, and a practical search rhythm.',
