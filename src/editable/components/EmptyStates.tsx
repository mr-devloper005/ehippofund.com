...
export function EmptyState({
  ...
  return (
    <section className={cn('rounded-[16px] border border-current/10 bg-current/[0.03] p-8 text-center', className)}>
      <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-[4px] bg-current/10">
      ...
      <Link href={actionHref} className="mt-6 inline-flex items-center gap-2 rounded-[4px] border border-current/15 px-5 py-3 text-sm font-semibold transition hover:bg-current hover:text-background">
        {actionLabel}
